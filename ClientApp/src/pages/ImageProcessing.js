...
export class ImageProcessing extends Component {
    static displayName = ImageProcessing.name;

    render() {
        return (
            <div>
                <div className="page-title-area img-processing-service">
                    <div className="d-table">
                        <div className="d-table-cell">
                            <div className="container">
                                <div className="page-title-content">
                                    <h2>Image Processing Service</h2>
                                    <ul>
